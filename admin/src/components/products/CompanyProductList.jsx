...
import {getCompanyProductList as getProductListAction, dismissMessage as dismissMessageAction} from '../../actions/products/creators/product';
...
class List extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.getProductListAction(id, this.props.token)
      .then(action => this.setState({products: action.payload}));
  }
  ...
  render() {
    const {successMessage, role} = this.props;
    const {showMsg, showInCartMsg, products} = this.state;
